...
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Knowledge Hub List <a href="{{ route('admin.knowledge-hub.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Knowledge Hub</button></a></h4>
                    </div>
                    <div class="card-body">
    ...
    @section('scripts')
        ...
        <script>
            ...
            function loadGrid() {
                fetch('{{ route('admin.knowledge-hub.index') }}', { // ✅ use indexdata route here
                     headers: { 
                        ...
                        columns: [
                            "Name",
                            {
                                ...
                                formatter: (cell, row) => {
                                    ...
                                    const logoUrl = `/assets/uploads/knowledge-hubs/${logo}`; // Construct URL dynamically
            ...
            function deleteRecord(id) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'DELETE',
                            url: "{{ url('admin/knowledge-hub') }}/" + id,
            ...
            function editRecord(id) {
                const editUrl = "{{ url('admin/knowledge-hub') }}/" + id + "/edit";
