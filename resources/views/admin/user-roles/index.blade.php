        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">User Role List <a href="{{ route('admin.user-role.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New User Role</button></a></h4>
...
@section('scripts')
    ...
    <script>
        ...
        function loadGrid() {
            fetch('{{ route('admin.user-role.index') }}', { // ✅ use indexdata route here
                headers: { 
        ...
        document.addEventListener('DOMContentLoaded', loadGrid);
         ...
         function editRecord(id) {
            const editUrl = "{{ url('admin/user-role') }}/" + id + "/edit";
