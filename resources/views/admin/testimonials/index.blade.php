        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Testimonial List <a href="{{ route('admin.testimonial.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Testimonial</button></a></h4>
...
@section('scripts')
    ...
    <script>
        ...
        function loadGrid() {
            fetch('{{ route('admin.testimonial.index') }}', { // ✅ use indexdata route here
                 headers: { 
                    ...
                    columns: [
                        "Name",
                        {
                            ...
                            formatter: (cell, row) => {
                                ...
                                const logoUrl = `/assets/uploads/testimonials/${logo}`; // Construct URL dynamically
        ...
        function editRecord(id) {
            const editUrl = "{{ url('admin/testimonial') }}/" + id + "/edit";
