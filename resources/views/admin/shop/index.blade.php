...
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Shop List <a href="{{ route('admin.shop.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Shop</button></a></h4>
                    </div>
                    <div class="card-body">
    ...
    @section('scripts')
        ...
        <script>
            ...
            function loadGrid() {
                fetch('{{ route('admin.shop.index') }}', { // ✅ use indexdata route here
                     headers: { 
                        ...
                        columns: [
                            "Name",
                            {
                                ...
                                formatter: (cell, row) => {
                                    ...
                                    const logoUrl = `/assets/uploads/shop/${logo}`; // Construct URL dynamically
            ...
            function editRecord(id) {
                const editUrl = "{{ url('admin/shop') }}/" + id + "/edit";
