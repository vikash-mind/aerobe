        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Users List <a href="{{ route('admin.user.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New User</button></a></h4>
...
@section('scripts')
    ...
    <script>
        ...
        function loadGrid() {
            fetch('{{ route('admin.user.index') }}', { // ✅ use indexdata route here
                headers: { 
        ...
        document.addEventListener('DOMContentLoaded', loadGrid);
         ...
         function editRecord(id) {
            const editUrl = "{{ url('admin/user') }}/" + id + "/edit";
