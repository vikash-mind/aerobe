...
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Aeroby Academy List <a href="{{ route('admin.aerobe-academy.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Aeroby Academy</button></a></h4>
                    </div>
                    <div class="card-body">
    ...
    @section('scripts')
        ...
        <script>
            ...
            function loadGrid() {
                fetch('{{ route('admin.aerobe-academy.index') }}', { // ✅ use indexdata route here
                     headers: { 
                        ...
                        columns: [
                            "Name",
                            {
                                ...
                                formatter: (cell, row) => {
                                    ...
                                    const logoUrl = `/assets/uploads/aerobe-academies/${logo}`; // Construct URL dynamically
            ...
            function deleteRecord(id) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'DELETE',
                            url: "{{ url('admin/aerobe-academy') }}/" + id,
            ...
            function editRecord(id) {
                const editUrl = "{{ url('admin/aerobe-academy') }}/" + id + "/edit";
