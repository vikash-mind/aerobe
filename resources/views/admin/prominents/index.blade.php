...
@section('page-title')
    Prominents Customer Management
@endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Prominents Customer List <a href="{{ route('admin.prominent.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Prominents Customer</button></a></h4>
...
@section('scripts')
    ...
    <script>
        ...
        function loadGrid() {
            fetch('{{ route('admin.prominent.index') }}', { // ✅ use indexdata route here
                headers: { 
                    ...
                    columns: [
                        "Name",
                        {
                            ...
                            formatter: (cell, row) => {
                                ...
                                const logoUrl = `/assets/uploads/prominents/${logo}`; // Construct URL dynamically
        ...
        function editRecord(id) {
            const editUrl = "{{ url('admin/prominent') }}/" + id + "/edit";
