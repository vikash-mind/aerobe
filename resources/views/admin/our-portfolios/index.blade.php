...
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Our Portfolio List <a href="{{ route('admin.our-portfolio.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Our Portfolio</button></a></h4>
                    </div>
                    <div class="card-body">
    ...
    @section('scripts')
        ...
        <script>
            ...
            function loadGrid() {
                fetch('{{ route('admin.our-portfolio.index') }}', { // ✅ use indexdata route here
                     headers: { 
                        ...
                        columns: [
                            "Name",
                            {
                                ...
                                formatter: (cell, row) => {
                                    ...
                                    const logoUrl = `/assets/uploads/our-portfolios/${logo}`; // Construct URL dynamically
            ...
            function deleteRecord(id) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'DELETE',
                            url: "{{ url('admin/our-portfolio') }}/" + id,
            ...
            function editRecord(id) {
                const editUrl = "{{ url('admin/our-portfolio') }}/" + id + "/edit";
