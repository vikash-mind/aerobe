            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Tag List <a href="{{ route('admin.tag.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Tag</button></a></h4>
...
function loadGrid() {
    fetch('{{ route('admin.tag.index') }}', { // ✅ use indexdata route here
...
document.addEventListener('DOMContentLoaded', loadGrid);
 ...
 function editRecord(id) {
    const editUrl = "{{ url('admin/tag') }}/" + id + "/edit";
