        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Main Menu List <a href="{{ route('admin.main-menu.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Main Menu</button></a></h4>
...
@section('scripts')
    ...
    <script>
        ...
        function loadGrid() {
            fetch('{{ route('admin.main-menu.index') }}', { // ✅ use indexdata route here
                headers: { 
        ...
        document.addEventListener('DOMContentLoaded', loadGrid);
            ...
            const editUrl = "{{ url('admin/main-menu') }}/" + id + "/edit";
