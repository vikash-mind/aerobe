        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Category List <a href="{{ route('admin.category.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Category</button></a></h4>
...
@section('scripts')
    ...
    <script>
        ...
        function loadGrid() {
            fetch('{{ route('admin.category.index') }}', { // ✅ use indexdata route here
        ...
        function editRecord(id) {
            const editUrl = "{{ url('admin/category') }}/" + id + "/edit";
