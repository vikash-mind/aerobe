...
@section('title')
    Legal Information Menu Management
@endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Legal Information Menu List <a href="{{ route('admin.legal-information-menu.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Legal Information Menu</button></a></h4>
...
@section('scripts')
    ...
    <script>
        ...
        function loadGrid() {
            fetch('{{ route('admin.legal-information-menu.index') }}', { // ✅ use indexdata route here
        ...
        function deleteRecord(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'DELETE',
                        url: "{{ url('admin/legal-information-menu') }}/" + id,
        ...
        function editRecord(id) {
            const editUrl = "{{ url('admin/legal-information-menu') }}/" + id + "/edit";
