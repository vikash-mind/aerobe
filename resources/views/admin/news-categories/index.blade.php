        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">News Category List <a href="{{ route('admin.news-category.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New News Category</button></a></h4>
...
@section('scripts')
    ...
    <script>
        ...
        function loadGrid() {
            fetch('{{ route('admin.news-category.index') }}', { // ✅ use indexdata route here
        ...
        function editRecord(id) {
            const editUrl = "{{ url('admin/news-category') }}/" + id + "/edit";
