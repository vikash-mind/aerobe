...
@section('title')
    Connect With Us Menu Management
@endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Connect With Us Menu List <a href="{{ route('admin.connect-with-us-menu.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Connect With Us Menu</button></a></h4>
...
@section('scripts')
    ...
    function loadGrid() {
        fetch('{{ route('admin.connect-with-us-menu.index') }}', { // ✅ use indexdata route here
         headers: { 
    ...
    function deleteRecord(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'DELETE',
                    url: "{{ url('admin/connect-with-us-menu') }}/" + id,
    ...
    function editRecord(id) {
        const editUrl = "{{ url('admin/connect-with-us-menu') }}/" + id + "/edit";
